...
#    Updated: 2022/04/12 08:11:35 by bguyot           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_lstmax.c ft_lstmin.c get_next_line.c ft_min.c ft_max.c ft_sqrt.c 			\
...
ft_printf/ft_printf_upper_xint.c ft_strndup.c ft_print_tab.c ft_strcmp.c;
OBJS 		= ${SRCS:.c=.o}
CC			= gcc
RM			= rm -f
